...
import net.henryhc.sustech.javajudge.fall19.assignment1.problemsAssignment1
import net.henryhc.sustech.javajudge.fall19.pretest1.problemsPretest1
import java.io.File
...
fun main(args: Array<String>) {
    ...
    val assignment = Assignment(args[0], problemsAssignment1)
